...
public class TransferServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            List<User> transferList = Factory.getInstance().getTransferService().getTransferList(user.getContract_address());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            int transfer = Factory.getInstance().getTransferService().transfer(recipientAddress, collectionItem, contractAddress, market);
